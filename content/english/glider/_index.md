...
<div class="float-left w-1/4 ml-1 mb-1 mr-4">
  <img src="/assets/images/glider/2.png" alt="Ocean-atmosphere processes" class="rounded-lg">
...
<div class="float-right w-1/4 ml-6 mb-4">
  <img src="/assets/images/glider/3.png" alt="Ocean-atmosphere processes" class="rounded-lg">
...
<div class="flex justify-center items-start gap-12 clear-both w-full my-8">
  ...
  <div class="w-1/4">
    <img src="/assets/images/glider/4.png" alt="Glider Deploying" class="rounded-lg w-full">
    <p class="text-xs text-center italic mt-2">ESNZ’s Alice Overend about to deploy an ocean glider.</p>
  </div>

  <div class="w-1/4">
    <img src="/assets/images/glider/5.png" alt="Glider Path Around NZ" class="rounded-lg w-full">
